...
(define-test test-imported-libraries
  (let* ((file "~/discompiler/SampleExecutables/myfavlibrary.exe")
    ...
    (assert-equalp (cadr (nth 8 imports))
                   '((9424324 9431304 " 5 <-hint   GetFileVersionInfoSizeW")
                     (9424328 9431282 " 6 <-hint   GetFileVersionInfoW")
                     (9424332 9431264 " 14 <-hint   VerQueryValueW")))
    (assert-equalp "OLEAUT32.dll" (car (nth 17 imports)))
    (assert-eq 21 (length (cadr (nth 17 imports))))
    (assert-equalp (cadr (nth 17 imports))
                   '((9423116 2147483650 2) ; 2 is import ordinal
                     (9423120 2147483652 4)
                     (9423124 2147483664 16)
                     (9423128 2147483672 24)
                     (9423132 2147483671 23)
                     (9423136 2147484059 411)
                     (9423140 2147483654 6)
                     (9423144 2147483656 8)
                     (9423148 2147483660 12)
                     (9423152 2147484068 420)
                     (9423156 2147483762 114)
                     (9423160 2147483655 7)
                     (9423164 2147483832 184)
                     (9423168 2147483833 185)
                     (9423172 2147483657 9)
                     (9423176 2147483658 10)
                     (9423180 2147483663 15)
                     (9423184 2147483665 17)
                     (9423188 2147483666 18)
                     (9423192 2147483668 20)
