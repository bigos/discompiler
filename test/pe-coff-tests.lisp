...
(test test-executable-integrity
  ...
  (is (equalp #(239 201 88 57 106 122 126 247 230 212 165 43 151 81 46 24)
              (md5:md5sum-file "~/discompiler/SampleExecutables/PE/DLLs/CRYPT32.dll")))
  ...
  (is (equalp #(60 209 206 16 108 162 169 180 204 98 109 125 240 63 189 111)
              (md5:md5sum-file "~/discompiler/SampleExecutables/PE/DLLs/MSASN1.dll")))
  ...
  (is (equalp #(31 87 235 91 146 178 172 127 157 113 167 125 24 77 140 19)
              (md5:md5sum-file "~/discompiler/SampleExecutables/PE/DLLs/MSVCP60.dll")))
